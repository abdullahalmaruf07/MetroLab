...
const Contuct = () => {
    return (
        ...
        <div className="aboutBackdround">
            <h1 className="mb-1 text-light text-center pt-5 fw-bold"><span style={{fontSize:'5rem'}}>FOOD ZONE</span></h1>
        </div>

        {/* about page heading end */}

        <Container className="text-center">
            <h1 className="mb-3">Contuct</h1>
            <ul>
                <li>Goal</li>
                <li>Achievement</li>
                <li>Location</li>
            ...
            <div className="text-center pb-5">
                ...
                <p>Food texture is defined as those properties of a food that are sensed by touch in the mouth and with the hands. We use many words to describe food texture—foods can be soft or hard, mushy or crunchy, or smooth or lumpy. Texture is important to the enjoyment and acceptability of foods. Would you enjoy a mushy apple or soggy toast?</p>
            </div>
            <div className="text-center pt-5">
                <h1>FOOD TEXTURE AND SWALLOWING PROBLEMS</h1>
